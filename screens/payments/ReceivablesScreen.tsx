      ...
      <div className="flex items-center justify-start gap-20 mb-2">
        <div className="flex items-center gap-4 rounded-3xl bg-white p-5">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-cyan-100">
            <DownloadIcon className="text-3xl text-cyan-500" />
          </div>
          <div className="flex flex-col">
            <div className="mb-1 text-base text-gray-700">Нийт орлого</div>
            <div className="text-xl font-bold text-gray-900">155,633,678₮</div>
          </div>
        </div>

        <div className="flex items-center gap-4 rounded-3xl bg-white p-5">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-cyan-100">
            <UploadIcon className="text-3xl text-cyan-500" />
          </div>
          <div className="flex flex-col">
            <div className="mb-1 text-base text-gray-700">Нийт зарлага</div>
            <div className="text-xl font-bold text-gray-900">155,633,678₮</div>
          </div>
        </div>
      </div>
